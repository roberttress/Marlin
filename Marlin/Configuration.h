...
#define STRING_CONFIG_H_AUTHOR "Robert Tress" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Embroidery Machine RT"
...
//#define PSU_NAME "Power Supply"
  ...
  //#define PSU_POWERUP_GCODE  "M211 S0"  // G-code to run after power-on (e.g., case light on)
...
#define PID_MAX  204      // Limit hotend current while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    // Original Hotend mit Dii-Cooler 18.05.2020 - neues Mainboard
    #define DEFAULT_Kp 26.54
    #define DEFAULT_Ki 1.72
    #define DEFAULT_Kd 102.42
  #endif
#else
...
//#define PIDTEMPBED
  ...
  // Original Hotend mit Dii-Cooler 17.05.2020
  #define DEFAULT_bedKp 98.30
  #define DEFAULT_bedKi 15.44
  #define DEFAULT_bedKd 417.24
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1600, 1600, 256000 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 60, 60, 1 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 5 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -27, -4, -1.28 }
...
#define HOMING_FEEDRATE_MM_M { (2*60), (2*60), (0.2*60) }
